...
class TestR3(unittest.TestCase):
    ...
    def test_add02(self):
        self.assertEqual(R3ApproxMatcher(self.a + R3(0.0, 0.0, 0.0)),
                         self.a)
    ...
    def test_add04(self):
        self.assertEqual(
            R3ApproxMatcher(self.a + R3(-1.0, -2.0, -3.0)),
            R3(0.0, 0.0, 0.0)
        )
    ...
    def test_sub04(self):
        self.assertEqual(R3ApproxMatcher(self.a - self.a),
                         R3(0.0, 0.0, 0.0))
    ...
    def test_ry03(self):
        self.assertEqual(
            R3ApproxMatcher(self.a.ry(pi)),
            R3(-self.a.x, self.a.y, -self.a.z)
        )

    def test_ry04(self):
        self.assertEqual(R3ApproxMatcher(self.a.ry(2 * pi)),
                         self.a)
    ...
    def test_dot02(self):
        self.assertEqual(self.a.dot(R3(0.0, 0.0, 0.0)),
                         0.0)
    ...
    def test_cross02(self):
        self.assertEqual(
            R3ApproxMatcher(self.a.cross(R3(0.0, 0.0, 0.0))),
            R3(0.0, 0.0, 0.0)
        )
    ...
    def test_sered03(self):
        self.assertEqual(
            R3ApproxMatcher(self.a.sered(R3(0.0, 0.0, 0.0))),
            R3(0.5, 1.0, 1.5)
        )

    def test_sered04(self):
        self.assertEqual(
            R3ApproxMatcher(R3(2.0, 2.0, 2.0).
